from .wang2024_common_utils_mbyolo import *

__all__ = ("Wang2024VSSBlock", "Wang2024SimpleStem", "Wang2024VisionClueMerge", "Wang2024XSSBlock")


class Wang2024SS2D(nn.Module):
    def __init__(
            self,
            # basic dims ===========
            d_model=96,
...
class Wang2024XSSBlock(nn.Module):
    def __init__(
            self,
            in_channels: int = 0,
            hidden_dim: int = 0,
        ...
        self.ss2d = nn.Sequential(*(Wang2024SS2D(d_model=self.hidden_dim,
                                         d_state=ssm_d_state,
                                         ssm_ratio=ssm_ratio,
...
class Wang2024VSSBlock(nn.Module):
    def __init__(
            self,
            in_channels: int = 0,
            hidden_dim: int = 0,
...
class Wang2024SimpleStem(nn.Module):
...
class Wang2024VisionClueMerge(nn.Module):
